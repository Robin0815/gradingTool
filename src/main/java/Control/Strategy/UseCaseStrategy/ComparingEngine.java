...
public class ComparingEngine {
    ...
    public static void compareSolutions(Solution tutorsolution,Solution studentsolution, double alpha){
        getSimilarityNumberOfElements(tutorsolution.getNumberOfElements(),studentsolution.getNumberOfElements(),alpha);
        getSimilarityRelations(tutorsolution.getReducedRelationIntegerMap(),studentsolution.getReducedRelationIntegerMap(),alpha);
    }

    private static void getSimilarityNumberOfElements(HashMap<Elements, Integer> map1, HashMap<Elements, Integer> map2, double alpha){
    ...
    private static void getSimilarityRelations(Map<ReducedRelation, Integer> map1, Map<ReducedRelation, Integer> map2, double alpha){
        ArrayList<Double> sampleList1 = new ArrayList<>();
        ArrayList<Double> sampleList2 = new ArrayList<>();
